...
class BaseBeanMapEmitter extends ClassEmitter {
    private static final Type BEAN_MAP = TypeUtils.parseType(BaseBeanMap.class.getName());
    ...
    public BaseBeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
        super(v);
