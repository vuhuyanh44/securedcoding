...
public class HrmExpressionEvaluator extends CachedExpressionEvaluator {
    ...
    public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
        ...
        HrmExpressionRootObject rootObject = new HrmExpressionRootObject(method, args, target, targetClass, targetMethod);
